  ...
  return (
    <>
      <div>
        ...
        {show && (
          <div className="pb-9 bg-[#141414] pt-10">
            <div className="flex flex-col md:flex-row  md:justify-between gap-20 md:gap-0 w-full xl:max-w-[1440xp]  xl:pr-20 px-4">
              <div className="flex  relative flex-col gap-1">
                ...
                <div className="flex justify-center border-[1px] border-white items-center max-w-[157px] relative ">
                  <button
              ...
              <div className="grid md:grid-cols-1 grid-cols-2 gap-5  md: h-max">
                <button
                  className=" bg-[#FF00FF]  py-2 px-2 lg:w-56 md:w-40 h-10 rounded-md text-white"
                  onClick={() => {
                ...
                <button
                  className=" bg-[#FF0000]  py-2 px-2 lg:w-56 md:w-40 h-10 rounded-md text-white"
                  onClick={() => {
                ...
                <button
                  className=" bg-[#309c00]  py-2 px-2 lg:w-56 md:w-40 h-10 rounded-md text-white"
                  onClick={() => getBlockPositions({ id: 2 })}
                >
                  Questions
                </button>
                <button
                  className=" bg-[#fff40f]  py-2 px-2 lg:w-56 md:w-40 h-10 rounded-md text-white"
                ...
                <button
                  className=" bg-[#40E0D0]  py-2 px-2 lg:w-56 md:w-40 h-10 rounded-md text-white"
            ...
            <div className="mt-20 relative px-4">
              <div className="absolute text-red-500 top-[50px] left-[14px]">
                {message}
              </div>
              <div className="flex flex-col md:gap-11 gap-7">
                ...
                >
                  <div className="startpositon">
                    <div className="text-white"> Start Time</div>
                  ...
                  <div className="startpositon">
                    <div className="text-white"> End Time</div>
                ...
                >
                  <button
                    ...
                    className="sm:whitespace-nowrap px-5 py-3 rounded-md  text-white"
                  ...
                  <button
                    ...
                    // className="sm:whitespace-nowrap"
                    className="sm:whitespace-nowrap px-5 py-3  w-full max-w-lg rounded-md  text-white"
                    // className={styles.buttonStyle}
                    onClick={() =>
                      addExercises({
                        id: 2,
            ...
            <div className="mt-28 px-4">
              {blockList?.length == 0 && (
                <div className="pb-1 text-white">No Records </div>
              )}
              <table>
                <tr>
                  <th className="text-center text-white">Index</th>
                  <th className="text-center text-white">Startime</th>
                  <th className="text-center text-white"> EndTime</th>
                ...
                {blockList.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td className="text-center text-white">
                      {calculateTime(data.startPosition)}
                    </td>{" "}
                    <td className="text-center text-white">
                      {calculateTime(data.endPosition)}
                    </td>
                    <td
